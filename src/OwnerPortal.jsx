    ...
    <div className="min-h-screen overflow-y-auto" style={{ background: `linear-gradient(135deg, ${C.primaryDark} 0%, ${C.primary} 52%, ${C.bg} 52%)` }}>
      <div className="mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center gap-12 px-5 py-10 lg:px-10">
        <div className="hidden max-w-md flex-1 lg:block">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-white/80" style={fBody}>Pay KSh 99 for 30 days, upload your property, and keep it visible to students while your subscription is active.</p>
  ...
  return (
    <div className="min-h-screen" style={{ background: C.bg, color: C.ink }}>
      ...
      <main className="mx-auto max-w-6xl space-y-5 px-4 py-5 lg:px-8">
        ...
        {!active && listings.length > 0 && <div className="rounded-2xl px-4 py-3 text-[12px]" style={{ ...fBody, background: C.goldSoft, color: C.ink }}>Your existing listings are hidden from students until you renew your KSh 99 subscription.</div>}
